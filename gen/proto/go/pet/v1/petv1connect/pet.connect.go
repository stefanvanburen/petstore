...
import (
	...
	v1 "github.com/stefanvanburen/petstore/gen/proto/go/pet/v1"
	http "net/http"
	strings "strings"
)
...
type PetStoreServiceClient interface {
	...
	PurchasePet(context.Context, *connect_go.Request[v1.PurchasePetRequest]) (*connect_go.Response[v1.PurchasePetResponse], error)
}
...
func NewPetStoreServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PetStoreServiceClient {
	...
	return &petStoreServiceClient{
		...
		purchasePet: connect_go.NewClient[v1.PurchasePetRequest, v1.PurchasePetResponse](
			httpClient,
			baseURL+"/pet.v1.PetStoreService/PurchasePet",
			opts...,
		),
	}
}
...
type petStoreServiceClient struct {
	...
	purchasePet *connect_go.Client[v1.PurchasePetRequest, v1.PurchasePetResponse]
}
...
// PurchasePet calls pet.v1.PetStoreService.PurchasePet.
func (c *petStoreServiceClient) PurchasePet(ctx context.Context, req *connect_go.Request[v1.PurchasePetRequest]) (*connect_go.Response[v1.PurchasePetResponse], error) {
	return c.purchasePet.CallUnary(ctx, req)
}
...
func NewPetStoreServiceHandler(svc PetStoreServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/pet.v1.PetStoreService/PurchasePet", connect_go.NewUnaryHandler(
...
func (UnimplementedPetStoreServiceHandler) PurchasePet(context.Context, *connect_go.Request[v1.PurchasePetRequest]) (*connect_go.Response[v1.PurchasePetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("pet.v1.PetStoreService.PurchasePet is not implemented"))
}
