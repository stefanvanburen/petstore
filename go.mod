...
require (
	...
	buf.build/gen/go/acme/petapis/protocolbuffers/go v1.34.0-20220907172654-7abdb7802c8f.1
...
require (
	buf.build/gen/go/acme/paymentapis/protocolbuffers/go v1.34.0-20220907172603-9a877cf260e1.1 // indirect
